...
interface ThemedPrimaryButtonProps extends Omit<ComponentProps<typeof Button>, 'style' | 'variant'> {
  themeColor: string;
}
 ...
 */
export const ThemedPrimaryButton = forwardRef<HTMLButtonElement, ThemedPrimaryButtonProps>(
