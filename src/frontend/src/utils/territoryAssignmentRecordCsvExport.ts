import type { CheckoutRecord, Territory } from "../backend";
...
export function buildTerritoryAssignmentRecordCsv(
  ...
  for (const territory of territories) {
    ...
    const row: string[] = [territory.number, lastDateCompleted];
...
export function exportTerritoryAssignmentRecord(
  territories: Territory[],
): void {
